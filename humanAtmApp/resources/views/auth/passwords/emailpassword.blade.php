...
@section('title')
<title> Reset Link Sent| HumanATM</title>
@endsection
 ...
 <section id='' class='forgotpassword-container'>
    <div class = "container signup-content">
        ...
        <div class='forgotpassword-form'>
            <form action="" class="forgotpassword-innerform">
                <p class="forgotpassword-text"><span class="glyphicon glyphicon-ok-circle email-good"></span><br/ >
