        ...
        <section id='' class='forgotpassword-container'>
            <div class = "container signup-content">
                ...
                <div class='forgotpassword-form'>
                    <form  class="forgotpassword-innerform" method="POST" action="{{ route('password.email') }}">
                        {{ csrf_field() }}

                        <p class="forgotpassword-text"><i>All we need is your email to get you right back on track.</i></p>
                        <input type="email" name="email"  class="signup-data" id="" placeholder="Email Address" value="{{ old('email') }}">
