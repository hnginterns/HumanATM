        ...
        <div class = "container signup-content">
            ...
            <div class='signup-form'>
                <form action="" class="signup-innerform" method="POST" action="{{ route('login') }}">
                    ...
                    <p id='signup-forgot'><a href="{{ route('password.request') }}" class="" >Forgot Password?</a></P>
                        <input type="submit" class="signup-data" id="login-submit"value="LOGIN">
                        <p id='login-signin'><a href="{{ route('register') }}" class="" ><span id="login-span1">Dont have an account?</span> 
