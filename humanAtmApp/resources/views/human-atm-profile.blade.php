...
<div class="container-fluid blue-fall outerBox-margin">
     ...
     <div class="row box-margin">
             <div class="col-md-8 col-md-offset-2 box-border">
                ...
                <input type="button" value="WITHDRAW" class="btn btn-success profile-button col-sm-3 col-sm-offset-4" onClick="window.location.href='/withdraw/proceed/{{$human_atm_profile->id}}'">
            </div>
