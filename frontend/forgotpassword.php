    ...
    <section class='container'>
            <div class="signup-container">
                ...
                <div class='signup-form'>
                    <p class="forgotpassword-text"><i>All we need is your email to get you right back on track.</i></p>
                    <input type="email" name="signup-email"  class="signup-data" id="" placeholder="Email Address">
                    <input type="submit" class="signup-data" id="forgotpassword-submit" value="SEND">        
                </div>               
